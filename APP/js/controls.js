...
class FirstPersonControls {
    ...
    bindEvents() {
        ...
        document.body.addEventListener('mousedown', function(btn) {
            if(btn.button==1){
    ...
    update() {
        ...
        this.position.y = 15 + terrain.getHeightAt(x, z) * scale;
       ...
       var  sky = this.app.scene.getObjectByName("sky");
        sky.position.z = this.position.z;
        sky.position.x = this.position.x;
